...
return array(
    ...
    'modules'=>array(
        ...
        'gii'=>array(
            ...
            'password'=>'1', // Password เข้าใช้งาน Gii System
    ...
    'components'=>array(
        ...
        */
        ...
        'db'=>array(
            'connectionString' => 'mysql:host=localhost;dbname=db_comptour', // db_database คือ ชื่อฐานข้อมูล
            'emulatePrepare' => true,
            'username' => 'root', // Username เข้าสู่ Database
            'password' => '6368109', // Password เข้าสู่ Database
            'charset' => 'utf8',
        ),
        'errorHandler'=>array(
